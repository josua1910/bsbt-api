...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6282114499086 , key nya gratis kok gan, jadi santai ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Benniismael'+'BYY--SAYANG';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'beniismael') return res.json(loghandler.invalidKey)
